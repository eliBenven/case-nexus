...
- `search_case_law` — Search CourtListener for relevant case law
...
- **CourtListener API** integration for real-time case law search and citation verification
...
- **External APIs**: CourtListener (citation verification + case law search)
- **Legal Corpus**: 59 GA statutes, 8,952 USC sections, constitutional provisions, landmark cases

~16,200 lines of code across 9 source files. No React, no build step, no framework overhead — just a Flask app that talks to Claude.
